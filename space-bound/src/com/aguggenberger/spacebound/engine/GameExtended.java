...
import com.aguggenberger.spacebound.engine.loading.LoadingRenderer;
import com.aguggenberger.spacebound.engine.loading.TextLoadingRenderer;
...
import com.aguggenberger.spacebound.engine.diagnostics.DiagnosticsRenderer;
...
public abstract class GameExtended extends Game {
	...
	public void create() {
		...
		Engine.tweenManger = new TweenManager();
		Tween.registerAccessor(MusicWrapper.class, new MusicTweenAccessor());
		Engine.music = new MusicPlayer(Engine.tweenManger, prefs.getMusicVolume(), prefs.isMusicMuted());
	...
	public void render() {
		...
		Engine.tweenManger.update(delta);
