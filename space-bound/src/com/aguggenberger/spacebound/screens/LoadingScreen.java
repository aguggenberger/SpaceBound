...
import com.aguggenberger.spacebound.engine.actors.LoadingBar;
...
public class LoadingScreen extends StageScreen {
    ...
    public void show() {
        ...
        assets.load("atlas/loading.pack", TextureAtlas.class);
        assets.finishLoading();

        TextureAtlas atlas = assets.get("atlas/loading.pack", TextureAtlas.class);
    ...
    @Override
    public void hide() {
        assets.unload("atlas/loading.pack");
